...
|      |       |
|---------|-----------|
| Safety equipment in a car is fundamental. You just expect it. Would you buy a cheap car that had no safety equipment! I know I wouldn't. Our software should be the same. Why allow your teams to build applications that have no safety or security built into them. There is noting wrong with asking your technology department to prove that the software they produce and the infrastructure they run on are secured. And here is the kicker, demand proof. If you are presented with a [threat assessment](https://en.wikipedia.org/wiki/Threat_assessment) on a piece of paper or in a document or even a completed [pen test](https://en.wikipedia.org/wiki/Penetration_test), you should be nervous. That's like asking for a safety rating such as NCAP or NHTSA, by only allowing the tester to walk around the vehicle and check the door handles and tap on the windows. | ![Posh Git Shell](/assets/images/securityblogs/seatbelt.jpg) |
